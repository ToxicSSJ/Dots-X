 ...
 * los componentes para el PowerUp que remueve
 * un Dot seleccionado.
 * 
 * @author Abraham Lora
 *
 */
public class RemoveDotPowerUp extends DotPowerUp implements Serializable {

	private static final long serialVersionUID = 1784007978364305286L;
	...
	private final DotCalculation calculation = new DotCalculation() {
		...
		public DotResult getResult(StackPane grid, VBox vbox, LinkedList<GameDot> dots,
			...
			next.changeAttribute("affect", false);
	 ...
	 * 
	 */
	public RemoveDotPowerUp() {
		super();
		
		Font font = Font.loadFont(DotsX.getResource("fonts/Gem.ttf").toExternalForm(), 25);
		...
		Tooltip tip = new Tooltip("(!) Remueve un Dot.");
